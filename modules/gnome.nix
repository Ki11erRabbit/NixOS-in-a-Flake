...
let 
in if config.services.desktopManager.gnome.enable or false then
    ...
    files = [
        {
            ...
            location = "/usr/share/wayland-sessions/";
            text = ''
[Desktop Entry]
Name[ab]=GNOME
Name[af]=GNOME
...
Comment[hi]=यह सत्र आपको GNOME में लॉग इन करता है
...
Comment[nb]=Denne økten logger deg inn i GNOME
